...
func (f *fakeLogPrinterForPrinterTest) Info(c types.String, t time.Time, m types.String) {
    f.infoHasBeenCalled = true
}

func (f *fakeLogPrinterForPrinterTest) Debug(c types.String, t time.Time, m types.String) {
    f.debugHasBeenCalled = true
}

func (f *fakeLogPrinterForPrinterTest) Warning(c types.String, t time.Time, m types.String) {
    f.warningHasBeenCalled = true
}

func (f *fakeLogPrinterForPrinterTest) Error(c types.String, t time.Time, m types.String) {
    f.errorHasBeenCalled = true
}

func (f *fakeLogPrinterForPrinterTest) Print(c types.String, t time.Time, m types.String) {
...
func getNewTestPrinters() (Printers, *fakeLogPrinterForPrinterTest, *fakeLogPrinterForPrinterTest) {
    printers        := Printers{}
    fakePrinter1    := &fakeLogPrinterForPrinterTest{
        debugHasBeenCalled:     false,
        infoHasBeenCalled:      false,
