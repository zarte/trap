...
func TestMessagerPack(t *testing.T) {
    ...
    result              :=      messager.pack(0, 0, testDataSegment)
...
func BenchmarkMessagerFindBytePositions(b *testing.B) {
    ...
    data                :=      messager.pack(0, 0, testDataSegment)
...
func TestMessagerParse(t *testing.T) {
    ...
    go func() {
        ...
        for _, val := range fragmentized(messager.pack(0,
    ...
    messager.parse(dummyIO, &[]byte{}, func(b []byte) {
...
func BenchmarkMessagerParse(b *testing.B) {
    ...
    testData            :=      fragmentized(messager.pack(0,
...
func TestMessagerParsePreservedBuff(t *testing.T) {
    ...
    messager.parse(dummyIO, &pBuffer, func(b []byte) {},
        func(int, error) (*types.Throw) {
            return nil
        })
